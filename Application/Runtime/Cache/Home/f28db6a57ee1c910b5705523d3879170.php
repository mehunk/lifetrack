  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
          ...
          <?php if(is_array($er_list)): foreach($er_list as $key=>$er_info): ?><li>
  						<time class="cbp_tmtime"><span><?php echo ($er_info["er_date"]); ?></span> <span><?php echo (date("H:i",strtotime($er_info["er_starttime"]))); ?></span></time>
  						<div class="cbp_tmicon">
                <i class="glyphicon glyphicon-fullscreen"> </i>
              </div>
  						<div class="cbp_tmlabel">
  							<h2><?php echo ($er_info["er_sddesc"]); ?></h2>
  							<p><?php echo ($er_info["er_sddetail"]); ?></p>
  						</div>
